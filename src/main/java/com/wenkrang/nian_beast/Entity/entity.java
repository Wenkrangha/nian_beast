...
public class entity {
    ...
    public static void getEntitytwo(Location location) {
        ...
        //这是在北极熊原有的30滴血上增加30滴
        AttributeModifier modifier = new AttributeModifier("new MaxHealth", 10, AttributeModifier.Operation.ADD_NUMBER);
        maxHealthAttribute.addModifier(modifier);
        phantom.setHealth(50);

        maxHealthAttribute = phantom.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE);
        modifier = new AttributeModifier("new DAMAGE", 6, AttributeModifier.Operation.ADD_NUMBER);
        maxHealthAttribute.addModifier(modifier);
